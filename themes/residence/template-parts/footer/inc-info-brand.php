    ...
    <div class="row">
        <div class="col-xl-3">
            <div class="item-info wow fadeInUp">
                <?php esc_html_e('THAI HOANG Residence', 'residence'); ?>
                <p>
                    <?php esc_html_e('© Copyright 2018 thaihoangresidence.com', 'residence'); ?>
                    <br>
                    <?php esc_html_e('All Rights Reserved.', 'residence'); ?>
                </p>
            </div>
        </div>
